...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const localizedPlaceholders = document.querySelectorAll("[data-placeholder-en][data-placeholder-es]");
    const localizedOptions = document.querySelectorAll("option[data-label-en][data-label-es]");
    ...
    function updateLocalizedFormText(language) {
        localizedPlaceholders.forEach(function (field) {
            field.placeholder = language === "es"
                ? field.getAttribute("data-placeholder-es")
                : field.getAttribute("data-placeholder-en");
        });

        localizedOptions.forEach(function (option) {
            option.textContent = language === "es"
                ? option.getAttribute("data-label-es")
                : option.getAttribute("data-label-en");
        });
    }
